---
title: "SocialLogic family (ALv_SL_*)"
type: story
status: planned
priority: medium
estimate: M
...
Rebuild the **SocialLogic family (ALv_SL_*)** reports on Superset reading from the warehouse, as version-controlled dashboards-as-code, replacing the legacy DWRPT views. Per-report migration is tracked as subtasks under this story.
