---
title: "CDXP report family (ALv_CDXP_*)"
type: story
status: planned
priority: medium
estimate: L
...
Rebuild the **CDXP report family (ALv_CDXP_*)** reports on Superset reading from the warehouse, as version-controlled dashboards-as-code, replacing the legacy DWRPT views. Per-report migration is tracked as subtasks under this story.
