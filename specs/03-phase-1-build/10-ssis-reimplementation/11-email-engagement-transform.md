---
title: "Email engagement transform (GA / MailGun)"
type: story
status: planned
priority: high
estimate: M
...
Reimplement the **Email engagement transform (GA / MailGun)** transform against the original sources as an Airflow DAG + Python — preserving the business logic (dedup / standardize / match / aggregate) the SSIS module performed, without carrying its truncate-and-rebuild fragility.
