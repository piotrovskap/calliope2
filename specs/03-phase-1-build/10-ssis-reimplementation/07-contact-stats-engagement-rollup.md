---
title: "Contact-stats / engagement rollup"
type: story
status: planned
priority: high
estimate: M
...
Reimplement the **Contact-stats / engagement rollup** transform against the original sources as an Airflow DAG + Python — preserving the business logic (dedup / standardize / match / aggregate) the SSIS module performed, without carrying its truncate-and-rebuild fragility.
