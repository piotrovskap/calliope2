---
title: "CDXP performance transforms"
type: story
status: planned
priority: high
estimate: M
...
Reimplement the **CDXP performance transforms** transform against the original sources as an Airflow DAG + Python — preserving the business logic (dedup / standardize / match / aggregate) the SSIS module performed, without carrying its truncate-and-rebuild fragility.
