---
title: "CRM-DMS recipient matching"
type: story
status: planned
priority: high
estimate: L
...
Reimplement the **CRM-DMS recipient matching** transform against the original sources as an Airflow DAG + Python — preserving the business logic (dedup / standardize / match / aggregate) the SSIS module performed, without carrying its truncate-and-rebuild fragility.
