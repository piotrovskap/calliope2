...
(function () {
  ...
  var CTAS = {
    ...
    blueprint:   { h: 'Deploy inside your perimeter', a: null, s: 'Self-host enterprise AI in days. Stop choosing between moving fast and staying in control.', p: ['Book a demo', 'https://calliope.ai/contact'], sec: ['Download the PDF', '/blueprint/calliope-ai-deployment-blueprint.pdf'] },
